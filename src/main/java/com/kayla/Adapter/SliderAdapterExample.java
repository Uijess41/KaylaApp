...
public class SliderAdapterExample extends SliderViewAdapter<SliderAdapterExample.SliderAdapterVH> {
    ...
    List<SliderImageData.Data> sliderarraylist;

    public SliderAdapterExample(List<SliderImageData.Data> getDataAdapter, Context context) {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        SliderImageData.Data model=sliderarraylist.get(position);
